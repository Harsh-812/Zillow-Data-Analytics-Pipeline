...
s3_bucket = 'cleaned-zillow-data-bucket'
...
default_args = {
    ...
    'email': ['pranalidarekar02@gmail.com'],
...
with DAG('zillow_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_zillow_data_var")[0]}} s3://zillowbucket/',
        )

        is_file_in_s3_available = S3KeySensor(
        task_id='tsk_is_file_in_s3_available',
        bucket_key=f'{{{{ti.xcom_pull("tsk_extract_zillow_data_var")[1]}}}}',
